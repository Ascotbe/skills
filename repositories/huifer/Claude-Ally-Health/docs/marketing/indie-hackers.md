...
That thought became **WellAlly-health**.
...
**Check out the project:** [GitHub](https://github.com/huifer/WellAlly-health)
...
**TL;DR:** I built a privacy-first personal health system using Claude Code CLI. It's open source, local-only, and AI-powered. Check it out: [GitHub](https://github.com/huifer/WellAlly-health)
