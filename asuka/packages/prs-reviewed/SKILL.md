---
name: prs-reviewed
description: 'Get PRs a user reviewed on brave/brave-core. Shows PR number, title,
  author, state, and links. Triggers on: prs reviewed, reviewed prs, review activity,
