---
name: channel-audit
description: Audit Teams channels across your teams — identify inactive channels,
  low‑engagement conversations, channels with no recent posts, and recommend cleanup
  actions.
---
# Channel Audit
