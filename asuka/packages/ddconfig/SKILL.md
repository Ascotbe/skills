---
name: ddconfig
description: Configures or troubleshoots the Datadog MCP server `plugin:datadog:mcp`.
  Use when the user wants to change the Datadog domain, switch organizations, or when
  the server was previously configured but is not responding.
---
## Datadog MCP Server
