...
description: Adds a new extension point route to a Sitecore Marketplace app. Use when
  the user wants to add a custom field, dashboard widget, context panel, fullscreen
  page, or standalone route.
---
