...
description: Self-improving browser automation via the auto-research loop. Iteratively
  ...
  until it reliably passes. Supports parallel runs across multiple tasks using sub-agents.
  Use when you want to build or improve browser automation skills for specific website
  tasks.
---
