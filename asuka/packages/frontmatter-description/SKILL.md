...
description: Check and optimize MetaDescription frontmatter fields in VS Code documentation.
  Use when auditing, adding, or improving page descriptions for SEO and discoverability.
  Apply this when making content changes to markdown articles.
---
