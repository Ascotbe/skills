...
description: Trace how a contract has changed across its base agreement and all amendments
  ...
  me the amendment history", "where's the latest [clause]", "how has [provision] evolved",
  or uploads multiple versions of an agreement.
---
# /amendment-history
