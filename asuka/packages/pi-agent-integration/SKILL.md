...
description: Guides implementation and review of the latest `@earendil-works/pi-agent-core`
  API. Use when a task mentions Pi `Agent`, agent loops, streaming, tools, queues,
  continuation, proxying, aborts, sessions, skills, compaction, or the current `AgentHarness`
  scaffold.
---
