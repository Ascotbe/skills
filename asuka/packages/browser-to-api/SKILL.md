...
description: Turn a website's observable HTTP traffic into a best-effort OpenAPI 3.1
  ...
  API endpoints from a browser session, build an OpenAPI doc from network traffic,
  or document a third-party site's XHR/fetch surface for client integration.
---
# Browser to API
