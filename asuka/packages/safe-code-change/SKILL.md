...
description: After a code change, find affected tests, update them to match new behavior,
  then run the full validation pipeline once. Use when the user has made or asked
  for a code change and wants to make sure nothing is broken.
---
# Safe Code Change
