---
name: query
description: Execute a read-only CVM query on the Convex network. Use when reading
  on-chain state, checking balances, looking up accounts, or evaluating Convex Lisp
  expressions.
---
# Query Convex State
