...
description: Skills for Upstash Vector features, TypeScript/JavaScript SDK usage,
  and integrations. Use when users ask how to work with Vector, its TS SDK, features,
  or supported frameworks.
---
