---
name: infinite-moves
description: Bridges to the infinite-moves plugin for autonomous task execution. Activates
  when user mentions tasks, backlog, dev loop, ideate, generate tasks, sweep debt,
  or wants continuous development. Knows how to invoke /moves commands without user
  typing them.
---
