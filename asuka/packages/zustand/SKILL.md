---
name: zustand
description: Zustand adapter for json-render's StateStore interface. Use when integrating
  json-render with Zustand for state management via @json-render/zustand.
---
# @json-render/zustand
