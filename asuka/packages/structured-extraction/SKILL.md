...
description: Extract structured data matching a JSON schema from websites. Handles
  complex nested schemas, arrays, pagination, and validation. Always outputs via formatOutput.
---
