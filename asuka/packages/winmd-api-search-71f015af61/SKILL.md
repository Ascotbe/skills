---
name: winmd-api-search-71f015af61
description: Find and explore Windows desktop APIs. Use when building features that
  ...
  sensors, networking, etc. Discovers the right API for a task and retrieves full
  type details (methods, properties, events, enumeration values).
---
# WinMD API Search
