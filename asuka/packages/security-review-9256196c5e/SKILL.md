---
name: security-review-9256196c5e
description: Security code review for vulnerabilities. Use when asked to "security
  ...
  "OWASP review", or review code for injection, XSS, authentication, authorization,
  cryptography issues. Provides systematic review with confidence-based reporting.
---
<!--
