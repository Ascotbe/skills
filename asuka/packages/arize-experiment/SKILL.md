...
description: Creates, runs, and analyzes Arize experiments for evaluating and comparing
  ...
  evaluation workflows using the ax CLI. Use when the user mentions create experiment,
  run experiment, compare models, model performance, evaluate AI, experiment results,
  benchmark, A/B test models, or measure accuracy.
---
