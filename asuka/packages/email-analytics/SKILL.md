...
description: Analyze your email patterns over a time period — volume trends, top senders,
  response time estimates, busiest days, and unread backlog statistics.
---
# Email Analytics
