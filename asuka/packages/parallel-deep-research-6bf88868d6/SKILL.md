---
name: parallel-deep-research-6bf88868d6
description: 'ONLY use when user explicitly says ''deep research'', ''exhaustive'',
  ''comprehensive report'', or ''thorough investigation''. Slower and more expensive
  than parallel-web-search. For normal research/lookup requests, use parallel-web-search
  instead. Supports multi-turn: pass --previous-interaction-id from a prior research
  or enrichment to continue with context.'
---
# Deep Research
