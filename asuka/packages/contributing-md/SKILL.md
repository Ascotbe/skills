...
description: Generate or align a CONTRIBUTING.md for a Sentry SDK repository with
  the develop.sentry.dev standard template. Use when asked to "create contributing.md",
