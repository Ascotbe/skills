...
description: Adds Arize AX tracing to an LLM application for the first time. Follows
  ...
  after user confirmation. Use when the user wants to instrument their app, add tracing
  from scratch, set up LLM observability, integrate OpenTelemetry or openinference,
  or get started with Arize tracing.
---
