---
name: warden-c4efeb2cad
description: Run Warden to analyze code changes before committing. Use when asked
  to "run warden", "check my changes", "review before commit", "warden config", "warden.toml",
  "create a warden skill", "add trigger", or any Warden-related local development
  task.
---
