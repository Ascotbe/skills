...
Use the `npx awal@2.12.1 x402` commands to discover and inspect paid API endpoints available on the x402 bazaar marketplace. **No authentication or balance is required for searching.**
...
```bash
npx awal@2.12.1 x402 bazaar search <query> [-k <n>] [--network <network>] [--scheme <scheme>] [--max-price <price>] [--json]
```
...
```bash
npx awal@2.12.1 x402 bazaar list [--network <network>] [--full] [--refresh] [--json]
```
...
```bash
npx awal@2.12.1 x402 details <url> [--json]
```
...
npx awal@2.12.1 x402 bazaar search "weather"

# Search with more results
npx awal@2.12.1 x402 bazaar search "sentiment analysis" -k 10

# Browse all bazaar resources with full details
npx awal@2.12.1 x402 bazaar list --full
