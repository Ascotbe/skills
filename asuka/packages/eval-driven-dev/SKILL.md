...
description: Improve AI application with evaluation-driven development. Define eval
  ...
  benchmark, fix wrong behaviors, improve quality, or do quality assurance for any
  Python project that calls an LLM model.
---
