...
description: Builds UI components using the Blok design system for Sitecore Marketplace
  apps. Use when the user wants to create UI, add components, build a page layout,
  or work with Blok/shadcn components in a marketplace app.
---
