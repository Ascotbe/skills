...
description: Create and manage redirects in VS Code documentation when pages are moved,
  renamed, or deleted. Use when moving docs pages, renaming files, restructuring content,
  or when the user asks about redirects.
---
# Content Redirect
