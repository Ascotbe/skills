---
name: gemini-api-dev-951f5bcc88
description: Use this skill when building applications with Gemini API hosted models,
  ...
  video), implementing function calling, using structured outputs, or needing current
  model specifications. Covers SDK usage (google-genai for Python, @google/genai for
  JavaScript/TypeScript, com.google.genai:google-genai for Java, google.golang.org/genai
  for Go), model selection, and API capabilities.
---
