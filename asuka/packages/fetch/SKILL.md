...
description: 'Use this skill when the user wants to retrieve a URL without a full
  ...
  follow redirects, or get page source for simple scraping. Prefer it over a browser
  when JavaScript rendering and page interaction are not needed. Supports proxies
  and redirect control.'
---
