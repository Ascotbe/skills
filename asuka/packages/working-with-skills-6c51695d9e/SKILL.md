---
name: working-with-skills-6c51695d9e
description: Best practices for agents managing PostHog skills via the MCP `skill-*`
  ...
  any `skill-*` tool, asked to author or edit a shared skill, or troubleshoot why
  a skill write was rejected. Pairs with `skills-store` (which covers the raw tool
  surface) by adding the decision-tree, efficiency, and pitfall guidance.
---
