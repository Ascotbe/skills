...
description: 'Force-push a branch and all its downstream branches to origin. Auto-detects
  the downstream tree and skips branches already up-to-date. Triggers on: force push
  downstream, push chain, push all branches.'
---
