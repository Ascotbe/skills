---
name: setup
description: Set up the AWS DevOps Agent and AWS Security Agent connections. Use when
  the user says "set up", "configure", "connect", or when MCP tools are missing.
---
# Setup
