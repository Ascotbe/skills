...
description: Skill to resolve Docker vulnerabilities for the firebase-cli image. Use
  this skill when you need to check for vulnerabilities in the firebase-cli Docker
  image and address them.
---
