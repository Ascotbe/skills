...
description: Track and visualize ML training experiments with Trackio. Use when logging
  ...
  retrieving/analyzing logged metrics (CLI). Supports real-time dashboard visualization,
  alerts with webhooks, HF Space syncing, and JSON output for automation.
---
