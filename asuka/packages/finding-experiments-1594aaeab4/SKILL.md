---
name: finding-experiments-1594aaeab4
description: Resolves a PostHog experiment reference from natural language to a concrete
  ...
  by status (running, draft, stopped, archived), or otherwise refers to an experiment
  by anything other than its concrete ID.
---
# Finding experiments
