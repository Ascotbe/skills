...
description: Review a vendor agreement, NDA, or SaaS subscription against your playbook.
  ...
  into a single memo. Use when the user says "review this contract", "check this MSA",
  "is this NDA okay", "look at this SaaS agreement", or attaches an inbound agreement
  for review.
---
# /review
