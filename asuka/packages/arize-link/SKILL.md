...
description: Generates deep links to the Arize UI for traces, spans, sessions, datasets,
  ...
  sharing Arize resources with team members. Use when the user wants to link to or
  open a trace, span, session, dataset, evaluator, or annotation config in the Arize
  UI.
---
# Arize Link
