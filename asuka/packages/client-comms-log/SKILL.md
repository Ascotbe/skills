...
description: Log a client communication — call, email, text, letter, in-person, voicemail.
  ...
  items. Works alongside /client-letter and /status client. Use when logging a call
  or client email, reviewing a communication log, or asking "what did we tell [client]
  last time".
---
# /client-comms-log
