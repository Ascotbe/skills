---
name: take
description: Find a GitHub issue in tldraw/tldraw, assign it, implement it, verify
  it, and open a pull request. Use when the user invokes take, asks to take an issue,
  implement an issue, work on an issue number or URL, or pick up an issue from a description.
---
# Take
