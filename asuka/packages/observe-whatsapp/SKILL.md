...
description: 'Observe and troubleshoot WhatsApp in Kapso: search Logs across API,
  ...
  webhook retries; triage API errors; and run health checks. Use when investigating
  production issues, message failures, workflow behavior, or webhook delivery problems.'
---
# Observe WhatsApp
