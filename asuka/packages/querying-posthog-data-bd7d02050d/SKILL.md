---
name: querying-posthog-data-bd7d02050d
description: Required reading before writing any HogQL/SQL or calling execute-sql
  ...
  LLM traces). Covers HogQL syntax differences from ClickHouse SQL, system table schemas
  (system.*), available functions, query examples, and the schema-discovery workflow.
---
