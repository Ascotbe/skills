---
name: ddtoolsets
description: Manages toolsets for the Datadog MCP server `plugin:datadog:mcp`. Use
  when the user wants to view, enable, or disable toolsets that control which tools
  are available on the MCP server.
---
## Datadog MCP Server
