---
name: review-8ae2e065b3
description: 'Review code for quality, root cause analysis, and fix confidence. Supports
  PR review and local review of uncommitted/branch changes. Default mode is local
  (reviews current branch changes). Triggers on: review pr, review this pr, /review
  (pr_url), /review local, /review, check bot pr quality.'
---
# Code Review Skill
