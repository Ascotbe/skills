---
name: suggest
description: USE FOR query autocomplete/suggestions. Fast ((100ms). Returns suggested
  queries as user types. Supports rich suggestions with entity info. Typo-resilient.
---
