---
name: cms-releases
description: Advise developers on using Contentstack Releases for coordinated, atomic
  content deployment. Cover release creation, item management, staged deployment,
  webhook storm prevention, and CI/CD integration.
---
# Releases
