...
description: USE FOR getting AI-generated POI text descriptions. Requires POI IDs
  from local-place-search, or from web-search with result_filter=locations. Returns
  markdown descriptions grounded in web search context. Max 20 IDs per request.
---
