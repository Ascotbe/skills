---
name: cds-code
description: 'Provides a workflow for building and reviewing high-quality React and
  React Native UI with the Coinbase Design System (CDS). Use this skill to create
  UI or make visual changes to existing UI with CDS components, tokens, style props,
  ...
  Examples: "build this screen", "fix spacing on this component", "replace this UI
  with CDS components", "perform a CDS audit on our changes", "check our codebase
  for CDS adherence", "does this feature use CDS well?"'
---
# CDS Code Skill
