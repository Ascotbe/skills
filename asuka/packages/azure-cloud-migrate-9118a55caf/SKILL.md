---
name: azure-cloud-migrate-9118a55caf
description: 'Assess and migrate cross-cloud workloads to Azure with reports and code
  ...
  Fargate/Kubernetes/Cloud Run/Spring Boot→Container Apps. WHEN: migrate Lambda to
  Functions, AWS to Azure, migrate Beanstalk, migrate Heroku, migrate App Engine,
  Cloud Run migration, Fargate to ACA, ECS/Kubernetes/GKE/EKS to Container Apps, Spring
