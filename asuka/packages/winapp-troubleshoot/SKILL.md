...
description: Diagnose and fix common Windows app packaging, signing, identity, and
  SDK errors. Use when encountering errors with MSIX packaging, certificate signing,
  Windows SDK setup, or app installation.
---
## When to use
