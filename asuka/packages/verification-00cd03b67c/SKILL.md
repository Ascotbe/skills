---
name: verification-00cd03b67c
description: 'Full-story verification — infers what the user is building, then verifies
  the complete flow end-to-end: browser → API → data → response. Triggers on dev server
  start and ''why isn''t this working'' signals.'
---
