---
name: omni-query-16b1d502d9
description: Run queries against Omni Analytics' semantic layer using the REST API,
  ...
  analyze data, ask "how many", "what's the trend", "show me the data", retrieve dashboard
  query results, or perform any data retrieval through Omni's query engine. Also use
  when someone wants to programmatically extract data from an existing Omni dashboard
  or workbook.
---
# Omni Query
