---
name: architecture-a9224a7527
description: Use when navigating the codebase for the first time, adding a new client
  method, adding a new container handler/service, or understanding how a request flows
  from Worker through the Sandbox DO into the container. Covers the three-layer architecture,
