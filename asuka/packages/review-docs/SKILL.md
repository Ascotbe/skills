---
name: review-docs
description: Review and improve tldraw SDK documentation against the voice and docs
  guides, scoring each article and iterating until it passes. Use when asked to review
  docs, audit an article in apps/docs/content, check whether documentation follows
  the style guide, or improve existing documentation.
---
