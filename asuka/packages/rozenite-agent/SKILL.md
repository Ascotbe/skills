---
name: rozenite-agent
description: Use Rozenite for Agents through CLI-driven `rozenite agent` commands
  to inspect React Native DevTools data and Rozenite plugins on a live app target.
  Trigger this skill for shell-based debugging and live session work. For Node.js
  or TypeScript scripts, wrappers, automations, or other programmatic SDK usage, use
  `rozenite-agent-sdk` instead.
---
## CLI
