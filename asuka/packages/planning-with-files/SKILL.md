...
description: '**USE THIS FOR COMPLEX TASKS.** Implements Manus-style file-based planning
  for multi-step tasks. Creates task_plan.md, findings.md, and progress.md in .agent_cache/(task-name)/.
  Use when: implementing multiple APIs, refactoring modules, research tasks, or ANY
  task requiring )5 tool calls.'
---
# Planning with Files
