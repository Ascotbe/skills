---
name: deps-update
description: Update Python dependencies to latest versions using uv, regenerate lock
  and requirements.txt, then verify linting and tests pass. Fix breakage from API
  changes in bumped packages. Use when the user says "deps update", "bump dependencies",
  or "update deps".
---
# deps-update
