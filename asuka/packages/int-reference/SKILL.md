---
name: int-reference
description: 'Reference tables for Copilot Studio YAML authoring: triggers, actions,
  variables, entities, Power Fx functions, templates. Preloaded by author and advisor
  agents.'
---
