...
description: Sets up Neon Auth in Next.js App Router applications. Configures API
  routes, middleware, server components, and UI. Use when adding auth-only to Next.js
  apps (no database needed).
---
