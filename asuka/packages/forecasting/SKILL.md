---
name: forecasting
description: How to produce a demand forecast for a SKU, and when to delegate that
  to a subagent vs. compute it yourself. Load this for any task involving "forecast",
  "how much will we sell", "next month", promos, or seasonal SKUs.
---
