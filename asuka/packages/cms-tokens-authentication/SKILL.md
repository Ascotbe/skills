...
description: Advise developers on choosing the right Contentstack authentication method
  and token type for frontend, backend, automation, and third-party app use cases.
  Include security guidance, rate-limit awareness, and SSO considerations.
---
