...
description: Web search with full page content extraction. Use this skill whenever
  ...
  "what are people saying about", or "find articles about". Returns real search results
  with optional full-page markdown — not just snippets. Provides capabilities beyond
  Claude's built-in WebSearch.
---
# firecrawl search
