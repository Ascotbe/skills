...
description: Coding standards, conventions, and patterns for developing Python code
  in the Agent Framework repository. Use this when writing or modifying Python source
