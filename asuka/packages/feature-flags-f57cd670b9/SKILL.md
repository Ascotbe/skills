---
name: feature-flags-f57cd670b9
description: Create, modify, and remove feature flags in RedisInsight. Use when adding
  a new feature flag, introducing a dev flag, promoting a dev flag to regular, cleaning
  up old flags, or the user mentions feature flags, feature toggles, or gating features.
---
# Feature Flags
