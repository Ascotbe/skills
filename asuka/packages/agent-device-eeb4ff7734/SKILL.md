---
name: agent-device-eeb4ff7734
description: Interact with iOS simulator or Android emulator/device using snapshot-based
  coordinates. Uses accessibility tree snapshots for precise element targeting, with
  screenshot verification as fallback. Use when navigating the app on a simulator/emulator.
---
