---
name: daily-update
description: Generate a formatted async daily standup message for the Sentry SDK team
  channel. Use when asked to create a "daily update", "async daily", "standup update",
  or "async team update".
---
# Async Daily Update
