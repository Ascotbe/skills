---
name: log-summarizer
description: Summarize and analyze log entries from files or command output. Use when
  the user needs to parse logs, identify patterns, extract errors/warnings, or get
  a concise summary of log activity.
---
# Log Summarizer
