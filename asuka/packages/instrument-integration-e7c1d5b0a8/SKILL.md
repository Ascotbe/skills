---
name: instrument-integration-e7c1d5b0a8
description: Add PostHog SDK integration to your application. Use when setting up
  PostHog for the first time or reviewing PRs that need PostHog initialization. Covers
