...
description: 'Customize a Claude Code plugin for a specific organization''s tools
  and workflows. Use when: customize plugin, set up plugin, configure plugin, tailor
  plugin, adjust plugin settings, customize plugin connectors, customize plugin skill,
