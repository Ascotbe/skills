---
name: first-run-4b9a4aa87a
description: Guide a new user through their first computer-use agent run (env check,
  safe browser-only task, then open the trajectory viewer).
---
# First run
