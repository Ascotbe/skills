---
name: ai
description: AI SDK for Python (the `ai` package). Use when writing Python that calls
  LLMs or builds agents — model calls, streaming, tool calling, subagents, human-in-the-loop
  approvals, durable/serverless execution, telemetry, AI SDK UI chat backends, custom
  providers.
---
# AI SDK for Python
