---
name: exploring-apm-traces-4f7e1c9d22
description: Investigates distributed application performance using PostHog APM (OpenTelemetry
  ...
  spans, error spans, trace IDs, or span attributes — not AI observability traces
  or product logs. Uses posthog:query-apm-spans, posthog:apm-trace-get, posthog:apm-services-list,
  posthog:apm-attributes-list, and posthog:apm-attribute-values-list.
---
