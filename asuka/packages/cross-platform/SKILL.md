---
name: cross-platform
description: Cross-platform codebase exploration for Pocket Casts. Use when asked
  about Web, iOS, or Android implementation of a feature, or when comparing implementations
  across platforms.
---
